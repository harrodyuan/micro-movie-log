...
function getRandomPair(allMovies: Movie[]): [Movie, Movie] {
  ...
  // In the future, we can optimize this to pick items with similar Elo scores for better data quality.
            ...
            >
              ...
              <div className="col-span-1 md:col-span-2 text-center mt-8">
                <button 
                  ...
                  className="text-neutral-500 hover:text-white text-sm flex items-center justify-center gap-2 mx-auto transition-colors"
                >
